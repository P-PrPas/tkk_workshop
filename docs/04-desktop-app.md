...
grip_max_size_ratio: 3.0     # มือ/แก้ว ขนาดต้องใกล้กัน (กันมือชี้จากไกลแล้วทับกล่อง)
...
- **`hand_on_cup`** แทน "กำ + bbox ทับ" — **ไม่ดูว่ากำหรือแบ** (แก้วไม่มีหูต้องจับตรง ๆ
  ...
  (2) จุด landmark >= `grip_min_points` จุดตกในกล่องแก้ว — เพราะมือ *ห่อ* แก้ว จุดส่วนใหญ่เลยทับ
  กล่อง · `HoldState` (3/6) กันเฟรมที่วืบ
...
- `hand_on_cup` เช็กจาก "จุดมือห่ออยู่บนแก้ว + ขนาดพอ ๆ กัน" แทน "มือกำ" — แก้วไม่มีหูก็จับได้
